...
import "../css/DeliveryDetails.css"; // ✅ import CSS file
  ...
  const fetchAddresses = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3000/api/patient/address",
        {
        ...
        <>
          <div className="section">
            <div className="section-header">
              ...
              <button className="dev-btn" onClick={() => setShowForm("patient")}>
                + Add Patient
              </button>
            </div>
          ...
          <div className="section">
            <div className="section-header">
              ...
              <button className="dev-btn"  onClick={() => setShowForm("address")}>
                + Add Address
              </button>
            </div>
