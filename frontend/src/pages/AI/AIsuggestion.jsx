...
const AIsuggestion = () => {
  ...
  const getMedicineSuggestion = async (description, id) => {
    ...
    console.log("description, id",description, id)
    ...
    <>
     {!error ? <>
      <div style={{ textAlign: "center", marginBottom: "20px",marginTop:"20px" }}>
        ...
        >
          Personalized medicine recommendations generated based on your health
          condition and medical history. These are suggestions only—please
          consult a certified doctor before starting or changing any medication.
        </p>
      </div>
            ...
            <tbody>
              {medicalHistory.map((item) => (
                <tr key={item._id}>
                  ...
                  <td>{new Date(item.diagnosisDate).toLocaleDateString()}</td>
